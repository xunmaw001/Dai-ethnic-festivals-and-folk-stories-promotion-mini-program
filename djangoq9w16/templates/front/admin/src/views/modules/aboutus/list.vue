		...
		<template v-if="showFlag">
			<el-form class="center-form-pv" :style='{"margin":"0 0 20px"}' :inline="true" :model="searchForm">
				...
				<el-row :style='{"margin":"20px 0","display":"flex"}'>
					<el-button :style='{"border":"0","cursor":"pointer","padding":"0 24px","margin":"0 10px 0 0","outline":"none","color":"#fff","borderRadius":"20px 40px","background":"#5497f2","width":"auto","fontSize":"14px","height":"40px"}' v-if="isAuth('aboutus','新增')" type="success" @click="addOrUpdateHandler()">新增</el-button>
					<el-button :style='{"border":"0","cursor":"pointer","padding":"0 24px","margin":"0 10px 0 5px","outline":"none","color":"#fff","borderRadius":"20px 40px","background":"rgba(255, 0, 0, 1)","width":"auto","fontSize":"14px","height":"40px"}' v-if="isAuth('aboutus','删除')" :disabled="dataListSelections.length <= 0" type="danger" @click="deleteHandler()">删除</el-button>
			...
			<!-- <div> -->
				...
				@selection-change="selectionChangeHandler">
					...
					<el-table-column width="300" label="操作">
						<template slot-scope="scope">
							<el-button :style='{"border":"2px solid #67C23A","cursor":"pointer","padding":"0 10px","margin":"3px 6px 3px 0","outline":"none","color":"#67C23A","borderRadius":"10px 3px","background":"#edf7e7","width":"auto","fontSize":"14px","height":"32px"}' v-if=" isAuth('aboutus','查看')" type="success" size="mini" @click="addOrUpdateHandler(scope.row.id,'info')">详情</el-button>
							<el-button :style='{"border":"2px solid #4a8be2","cursor":"pointer","padding":"0 10px","margin":"3px 6px 3px 0","outline":"none","color":"#2774dc","borderRadius":"10px 3px","background":"#e7eef7","width":"auto","fontSize":"14px","height":"32px"}' v-if=" isAuth('aboutus','修改')" type="primary" size="mini" @click="addOrUpdateHandler(scope.row.id)">修改</el-button>





							<el-button :style='{"border":"2px solid #dd3a3a","cursor":"pointer","padding":"0 10px","margin":"3px 10px 3px 0","outline":"none","color":"#dd3a3a","borderRadius":"10px 6px","background":"#f7e7e7","width":"auto","fontSize":"14px","height":"32px"}' v-if="isAuth('aboutus','删除') " type="danger" size="mini" @click="deleteHandler(scope.row.id)">删除</el-button>
						</template>
					</el-table-column>
				</el-table>
				<el-pagination
