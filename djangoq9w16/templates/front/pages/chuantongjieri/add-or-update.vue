	...
	<view :style='{"minHeight":"100vh","padding":"0px 0 80rpx","borderColor":"#21d5ae","background":"url(http://codegen.caihongy.cn/20230308/302fb617e4e6405384ecd086ab1d7ea4.png) no-repeat right top / 50% auto,#fff","borderWidth":"0px 0 0","width":"100%","position":"relative","borderStyle":"dashed","height":"auto"}'>
		<form :style='{"width":"100%","padding":"60rpx 40rpx","background":"none","height":"auto"}' class="app-update-pv">
			<view :style='{"padding":"0 20rpx 0px","boxShadow":"inset 0px 0px 0px 0px #f9edd9","margin":"0 0 32rpx","borderColor":"#fbecf3","borderRadius":"0px","borderWidth":"2rpx 0","background":"url(http://codegen.caihongy.cn/20230307/fb55f80a11b145148308bc56cf4230d2.png) no-repeat left top,url(http://codegen.caihongy.cn/20230307/19118f2203184dd0bc351f80f12a3b51.png) no-repeat right bottom,rgba(255,255,255,.8)","display":"flex","width":"100%","lineHeight":"100rpx","borderStyle":"solid","height":"auto"}' class="">
				<view :style='{"width":"160rpx","padding":"0 20rpx 0 0","fontSize":"32rpx","color":"#333","textAlign":"right","fontWeight":"600"}' class="title">节日名称</view>
				<input :style='{"border":"0","padding":"0px 20rpx","margin":"0px","color":"#666","borderRadius":"8rpx","flex":"1","background":"rgba(255, 255, 255, 0)","fontSize":"28rpx"}' :disabled="ro.jierimingcheng" v-model="ruleForm.jierimingcheng" placeholder="节日名称"></input>
			</view>
			<view :style='{"padding":"0 20rpx 0px","boxShadow":"inset 0px 0px 0px 0px #f9edd9","margin":"0 0 32rpx","borderColor":"#fbecf3","borderRadius":"0px","borderWidth":"2rpx 0","background":"url(http://codegen.caihongy.cn/20230307/fb55f80a11b145148308bc56cf4230d2.png) no-repeat left top,url(http://codegen.caihongy.cn/20230307/19118f2203184dd0bc351f80f12a3b51.png) no-repeat right bottom,rgba(255,255,255,.8)","display":"flex","width":"100%","lineHeight":"100rpx","borderStyle":"solid","height":"auto"}' class=" select">
				...
				<picker :style='{"width":"100%","flex":"1","height":"auto"}' @change="jierileixingChange" :value="jierileixingIndex"  :range="jierileixingOptions">
					<view :style='{"width":"100%","lineHeight":"80rpx","fontSize":"28rpx","color":"#666"}' class="uni-input">{{ruleForm.jierileixing?ruleForm.jierileixing:"请选择节日类型"}}</view>
				</picker>
			</view>
			<view :style='{"padding":"0 20rpx 0px","boxShadow":"inset 0px 0px 0px 0px #f9edd9","margin":"0 0 32rpx","borderColor":"#fbecf3","borderRadius":"0px","borderWidth":"2rpx 0","background":"url(http://codegen.caihongy.cn/20230307/fb55f80a11b145148308bc56cf4230d2.png) no-repeat left top,url(http://codegen.caihongy.cn/20230307/19118f2203184dd0bc351f80f12a3b51.png) no-repeat right bottom,rgba(255,255,255,.8)","display":"flex","width":"100%","lineHeight":"100rpx","borderStyle":"solid","height":"auto"}' class="" @tap="fengmianTap">
				<view :style='{"width":"160rpx","padding":"0 20rpx 0 0","fontSize":"32rpx","color":"#333","textAlign":"right","fontWeight":"600"}' class="title">封面</view>
			...
			<view :style='{"padding":"0 20rpx 0px","boxShadow":"inset 0px 0px 0px 0px #f9edd9","margin":"0 0 32rpx","borderColor":"#fbecf3","borderRadius":"0px","borderWidth":"2rpx 0","background":"url(http://codegen.caihongy.cn/20230307/fb55f80a11b145148308bc56cf4230d2.png) no-repeat left top,url(http://codegen.caihongy.cn/20230307/19118f2203184dd0bc351f80f12a3b51.png) no-repeat right bottom,rgba(255,255,255,.8)","display":"flex","width":"100%","lineHeight":"100rpx","borderStyle":"solid","height":"auto"}' class="">
				<view :style='{"width":"160rpx","padding":"0 20rpx 0 0","fontSize":"32rpx","color":"#333","textAlign":"right","fontWeight":"600"}' class="title">由来年份</view>
				<input :style='{"border":"0","padding":"0px 20rpx","margin":"0px","color":"#666","borderRadius":"8rpx","flex":"1","background":"rgba(255, 255, 255, 0)","fontSize":"28rpx"}' :disabled="ro.youlainianfen" v-model="ruleForm.youlainianfen" placeholder="由来年份"></input>
			</view>
			<view :style='{"padding":"0 20rpx 0px","boxShadow":"inset 0px 0px 0px 0px #f9edd9","margin":"0 0 32rpx","borderColor":"#fbecf3","borderRadius":"0px","borderWidth":"2rpx 0","background":"url(http://codegen.caihongy.cn/20230307/fb55f80a11b145148308bc56cf4230d2.png) no-repeat left top,url(http://codegen.caihongy.cn/20230307/19118f2203184dd0bc351f80f12a3b51.png) no-repeat right bottom,rgba(255,255,255,.8)","display":"flex","width":"100%","lineHeight":"100rpx","borderStyle":"solid","height":"auto"}' class="">
				<view :style='{"width":"160rpx","padding":"0 20rpx 0 0","fontSize":"32rpx","color":"#333","textAlign":"right","fontWeight":"600"}' class="title">发布人</view>
				<input :style='{"border":"0","padding":"0px 20rpx","margin":"0px","color":"#666","borderRadius":"8rpx","flex":"1","background":"rgba(255, 255, 255, 0)","fontSize":"28rpx"}' :disabled="ro.faburen" v-model="ruleForm.faburen" placeholder="发布人"></input>
			</view>
			<view :style='{"padding":"0 20rpx 0px","boxShadow":"inset 0px 0px 0px 0px #f9edd9","margin":"0 0 32rpx","borderColor":"#fbecf3","borderRadius":"0px","borderWidth":"2rpx 0","background":"url(http://codegen.caihongy.cn/20230307/fb55f80a11b145148308bc56cf4230d2.png) no-repeat left top,url(http://codegen.caihongy.cn/20230307/19118f2203184dd0bc351f80f12a3b51.png) no-repeat right bottom,rgba(255,255,255,.8)","display":"flex","width":"100%","lineHeight":"100rpx","borderStyle":"solid","height":"auto"}' class=" select">
				<view :style='{"width":"160rpx","padding":"0 20rpx 0 0","fontSize":"32rpx","color":"#333","textAlign":"right","fontWeight":"600"}' class="title">发布时间</view>
			...
			<view :style='{"padding":"0 20rpx 0px","boxShadow":"inset 0px 0px 0px 0px #f9edd9","margin":"0 0 32rpx","borderColor":"#fbecf3","borderRadius":"0px","borderWidth":"2rpx 0","background":"url(http://codegen.caihongy.cn/20230307/fb55f80a11b145148308bc56cf4230d2.png) no-repeat left top,url(http://codegen.caihongy.cn/20230307/19118f2203184dd0bc351f80f12a3b51.png) no-repeat right bottom,rgba(255,255,255,.8)","display":"flex","width":"100%","lineHeight":"100rpx","borderStyle":"solid","height":"auto"}' class="">
				<view :style='{"width":"160rpx","padding":"0 20rpx 0 0","fontSize":"32rpx","color":"#333","textAlign":"right","fontWeight":"600"}' class="title">简介</view>
			...
			<view :style='{"padding":"12rpx 0","margin":"0 0 24rpx 0","borderColor":"#ccc","borderWidth":"0 0 0px 0","width":"100%","borderStyle":"solid","height":"auto"}' class="">
				<view :style='{"width":"100%","lineHeight":"80rpx","fontSize":"32rpx","color":"#333","fontWeight":"600"}' class="title">典故</view>
                <xia-editor ref="editor" :style='{"minHeight":"300rpx","padding":"24rpx 32rpx","boxShadow":"inset 0px 0px 0px 0px #f9edd9","borderColor":"#fbecf3","borderRadius":"0px","color":"#666","background":"url(http://codegen.caihongy.cn/20230307/fb55f80a11b145148308bc56cf4230d2.png) no-repeat left top,url(http://codegen.caihongy.cn/20230307/19118f2203184dd0bc351f80f12a3b51.png) no-repeat right bottom,#fff","borderWidth":"2rpx 0","width":"100%","fontSize":"32rpx","borderStyle":"solid","height":"auto"}' v-model="ruleForm.diangu" placeholder="典故" @editorChange="dianguChange"></xia-editor>
			</view>
...
<script>
	...
	export default {
		...
		async onLoad(options) {
			...
			// ss读取
			this.ruleForm.faburen = this.user.yonghuxingming
			this.ro.faburen = true;


			// 下拉框
			res = await this.$api.option(`jierileixing`,`jierileixing`,{});
			this.jierileixingOptions = res.data;
            this.jierileixingOptions.unshift("请选择节日类型");
			...
			if (options.id) {
				...
				// 获取信息
				res = await this.$api.info(`chuantongjieri`, this.ruleForm.id);
			...
			if(options.cross){
				...
				for (var o in obj){
					if(o=='jierimingcheng'){
					this.ruleForm.jierimingcheng = obj[o];
					this.ro.jierimingcheng = true;
					continue;
					}
					if(o=='jierileixing'){
					...
					if(o=='diangu'){
					this.ruleForm.diangu = obj[o];
					this.ro.diangu = true;
					continue;
					}
					if(o=='youlainianfen'){
					this.ruleForm.youlainianfen = obj[o];
					this.ro.youlainianfen = true;
					continue;
					}
					if(o=='faburen'){
		...
		methods: {
			...
			// 下拉变化
			jierileixingChange(e) {
				this.jierileixingIndex = e.target.value
				this.ruleForm.jierileixing = this.jierileixingOptions[this.jierileixingIndex]
			},
...
//跨表计算判断
				...
				if(crossrefid && crossuserid) {
					...
					let res = await this.$api.list(`chuantongjieri`, params);
                ...
                //跨表计算
						if(this.ruleForm.id){
							await this.$api.update(`chuantongjieri`, this.ruleForm);
						}else{
							await this.$api.add(`chuantongjieri`, this.ruleForm);
						}
