...
<script>
	export default {
		...
		methods: {
			// 支付
			onPayTap(){
				uni.setStorageSync('paytable','jierileixing');
			...
			onAcrossTap(tableName,crossOptAudit,statusColumnName,tips,statusColumnValue){
				uni.setStorageSync('crossTable','jierileixing');
			...
			// 获取详情
			async init(){
				let res = await this.$api.info('jierileixing', this.id);
			...
			// 添加评论
			async onCommentTap() {
				this.$utils.jump(`../discussjierileixing/add-or-update?refid=${this.id}`)
			},
			onSHTap() {
