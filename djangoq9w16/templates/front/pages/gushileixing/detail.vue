...
<script>
	export default {
		...
		methods: {
			// 支付
			onPayTap(){
				uni.setStorageSync('paytable','gushileixing');
			...
			onAcrossTap(tableName,crossOptAudit,statusColumnName,tips,statusColumnValue){
				uni.setStorageSync('crossTable','gushileixing');
			...
			// 获取详情
			async init(){
				let res = await this.$api.info('gushileixing', this.id);
			...
			// 添加评论
			async onCommentTap() {
				this.$utils.jump(`../discussgushileixing/add-or-update?refid=${this.id}`)
			},
			onSHTap() {
