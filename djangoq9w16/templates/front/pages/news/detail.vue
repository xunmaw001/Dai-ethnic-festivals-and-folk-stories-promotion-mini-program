		...
		<view class="container" :style='{"minHeight":"100vh","width":"100%","padding":"20rpx 0 132rpx","position":"relative","background":"#fff","height":"auto"}'>
            <view :style='{"padding":"0px 24rpx 24rpx","flexWrap":"wrap","background":"none","display":"flex","width":"100%","justifyContent":"space-between","height":"auto"}' class="detail-content">
				...
				<view class="detail-list-item" :style='{"boxShadow":"inset 0px 0px 0px 0px #f9edd9","padding":"20rpx 20rpx 20rpx","margin":"20rpx 0 20rpx 0","borderColor":"#fbecf3","borderRadius":"0px","flexWrap":"wrap","borderWidth":"2rpx","background":"url(http://codegen.caihongy.cn/20230307/fb55f80a11b145148308bc56cf4230d2.png) no-repeat left top,url(http://codegen.caihongy.cn/20230307/19118f2203184dd0bc351f80f12a3b51.png) no-repeat right bottom,#fff","display":"flex","width":"100%","borderStyle":"solid","height":"auto"}'>
					<view class="lable" :style='{"padding":"0 20rpx","borderColor":"#fbecf3","color":"#333","textAlign":"left","borderWidth":"0 0 2rpx","width":"100%","lineHeight":"68rpx","fontSize":"32rpx","borderStyle":"solid","fontWeight":"600"}'>标题：</view>
					<view  class="text" :style='{"padding":"12rpx 20rpx 20rpx 0","margin":"0px 0 0","color":"#666","width":"100%","lineHeight":"48rpx","fontSize":"32rpx","textIndent":"2em"}'>{{detail.title}}</view>
				</view>
				...
				<view class="detail-list-item" :style='{"boxShadow":"inset 0px 0px 0px 0px #f9edd9","padding":"20rpx 20rpx 20rpx","margin":"20rpx 0 20rpx 0","borderColor":"#fbecf3","borderRadius":"0px","flexWrap":"wrap","borderWidth":"2rpx","background":"url(http://codegen.caihongy.cn/20230307/fb55f80a11b145148308bc56cf4230d2.png) no-repeat left top,url(http://codegen.caihongy.cn/20230307/19118f2203184dd0bc351f80f12a3b51.png) no-repeat right bottom,#fff","display":"flex","width":"100%","borderStyle":"solid","height":"auto"}'>
					...
					<view class="text" :style='{"padding":"12rpx 20rpx 20rpx 0","margin":"0px 0 0","color":"#666","width":"100%","lineHeight":"48rpx","fontSize":"32rpx","textIndent":"2em"}'>{{detail.introduction}}</view>
				</view>
				...
				<view class="detail-list-item rich" :style='{"boxShadow":"inset 0px 0px 0px 0px #f9edd9","padding":"40rpx 24rpx","margin":"0 0 24rpx 0","borderColor":"#fbecf3","borderRadius":"0px","flexWrap":"wrap","borderWidth":"2rpx","background":"url(http://codegen.caihongy.cn/20230307/fb55f80a11b145148308bc56cf4230d2.png) no-repeat left top,url(http://codegen.caihongy.cn/20230307/19118f2203184dd0bc351f80f12a3b51.png) no-repeat right bottom,#fff","display":"flex","width":"100%","borderStyle":"solid","height":"auto"}'>
					<view class="lable" :style='{"padding":"0 20rpx 0 0","color":"#333","textAlign":"left","width":"100%","lineHeight":"1.5","fontSize":"32rpx","fontWeight":"600"}'>内容</view>
