...
<mescroll-uni @init="mescrollInit" :up="upOption" :down="downOption" @down="downCallback" @up="upCallback">
	<view class="content">
		<view :style='{"padding":"40rpx 0","borderColor":"#21d5ae","alignItems":"flex-start","display":"block","justifyContent":"space-between","minHeight":"100vh","flexWrap":"wrap","background":"url() fixed,#fff","borderWidth":"0px 0","width":"100%","position":"relative","borderStyle":"dashed","height":"auto"}'>
			...
			<view :style='{"width":"100%","alignItems":"flex-start","flexWrap":"wrap","background":"none","display":"flex","height":"auto"}'>
				...
				<view class="news-box1" :style='{"padding":"40rpx 24rpx 24rpx","margin":"0px 0 0","flexWrap":"wrap","background":"url() no-repeat center top","display":"flex","width":"100%","justifyContent":"space-between","height":"auto"}'>
					<view @tap="onDetailTap(product)" v-for="(product,index) in list" :key="index" class="list-item" :style='{"padding":"0px 0","margin":"0 0 40rpx","borderColor":"#fbd341 #eee #fbd341","borderRadius":"0px","flexWrap":"wrap","background":"none","borderWidth":"0px","display":"block","width":"100%","borderStyle":"solid","height":"auto"}'>
					  <view class="list-item-body" :style='{"padding":"20rpx","margin":"20rpx 0 0","borderColor":"#f8deea","borderRadius":"0px","borderWidth":"2rpx 0","background":"linear-gradient(180deg, rgba(255,255,255,1) 0%, rgba(255,248,251,1) 50%)","width":"60%","borderStyle":"solid","float":"left","height":"auto","order":"2"}'>
						<view :style='{"padding":"0 20rpx","margin":"0","whiteSpace":"nowrap","overflow":"hidden","color":"#454553","width":"100%","lineHeight":"48rpx","fontSize":"32rpx","textOverflow":"ellipsis","fontWeight":"600"}' class="title ">{{product.title}}</view>
					  ...
					  <image :style='{"boxShadow":"8rpx -8rpx 0px #fbd8e8","margin":"0 auto","objectFit":"cover","borderRadius":"20rpx","display":"block","width":"36%","float":"right","height":"240rpx"}' mode="aspectFill" class="listmpic" :src="baseUrl+product.picture"></image>
					</view>
				</view>
		...
		<button :style='{"border":"2rpx solid #fff","boxShadow":"0 4rpx 8rpx rgba(0,0,0,.1)","color":"#333","bottom":"120rpx","right":"128rpx","outline":"none","borderRadius":"100%","background":"#f8deea","width":"88rpx","lineHeight":"88rpx","fontSize":"28rpx","position":"fixed","height":"88rpx","zIndex":"9999"}' v-if="userid && isAuth('news','新增')" class="add-btn" @click="onAddTap()">新增</button>
		<button :style='{"border":"2rpx solid #fff","boxShadow":"0 4rpx 8rpx rgba(0,0,0,.1)","color":"#333","bottom":"120rpx","right":"128rpx","outline":"none","borderRadius":"100%","background":"#f8deea","width":"88rpx","lineHeight":"88rpx","fontSize":"28rpx","position":"fixed","height":"88rpx","zIndex":"9999"}' v-if="!userid && isAuthFront('news','新增')" class="add-btn" @click="onAddTap()">新增</button>
	</view>
</mescroll-uni>
</template>
