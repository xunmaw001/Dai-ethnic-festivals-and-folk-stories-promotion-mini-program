...
<mescroll-uni @init="mescrollInit" :up="upOption" :down="downOption" @down="downCallback" @up="upCallback">
	<view class="content">
		<view :style='{"padding":"40rpx 0","borderColor":"#21d5ae","alignItems":"flex-start","display":"block","justifyContent":"space-between","minHeight":"100vh","flexWrap":"wrap","background":"url() fixed,#fff","borderWidth":"0px 0","width":"100%","position":"relative","borderStyle":"dashed","height":"auto"}'>
			...
			<view class="list" :style='{"width":"calc(100% - 220rpx)","padding":"24rpx","margin":"0","flex":"1","height":"auto"}'>
				<view @tap="onDetailTap(product)" class="listm flex flex-between" :style='{"border":"0px solid #f5eae2","boxShadow":"0 0px 0px rgba(0,0,0,.3)","padding":"0px","margin":"0 0 40rpx","alignItems":"center","flexWrap":"wrap","background":"none","display":"flex","width":"100%","height":"auto"}' v-for="(product,index) in list" :key="index">
				  <image :style='{"padding":"0 40rpx","margin":"0 auto 10rpx","objectFit":"cover","borderRadius":"16rpx","background":"url(http://codegen.caihongy.cn/20230307/24100fcd15304f63a90bf00786ba1f3d.png) no-repeat left center / 100% 80%","display":"block","width":"100%","height":"240rpx"}' mode="aspectFill" class="listmpic" v-if="preHttp(product.touxiang)" :src="product.touxiang.split(',')[0]"></image>
				  <image :style='{"padding":"0 40rpx","margin":"0 auto 10rpx","objectFit":"cover","borderRadius":"16rpx","background":"url(http://codegen.caihongy.cn/20230307/24100fcd15304f63a90bf00786ba1f3d.png) no-repeat left center / 100% 80%","display":"block","width":"100%","height":"240rpx"}' mode="aspectFill" class="listmpic" v-else :src="product.touxiang?baseUrl+product.touxiang.split(',')[0]:''"></image>

				  <view class="listmr" :style='{"width":"calc(100% - 0px)","padding":"0","margin":"8rpx 0 0","height":"auto"}'>
					<view class="col3 f30 elip mb15" :style='{"padding":"0 20rpx","margin":"0 20rpx 20rpx","borderColor":"#f2c2d8","whiteSpace":"nowrap","color":"#333","overflow":"hidden","background":"none","borderWidth":"0 0 2rpx","width":"calc(100% - 40rpx)","lineHeight":"48rpx","fontSize":"28rpx","textOverflow":"ellipsis","borderStyle":"solid"}'>用户姓名:{{product.yonghuxingming}}</view>
				  </view>
		...
		<button :style='{"border":"2rpx solid #fff","boxShadow":"0 4rpx 8rpx rgba(0,0,0,.1)","color":"#333","bottom":"120rpx","right":"128rpx","outline":"none","borderRadius":"100%","background":"#f8deea","width":"88rpx","lineHeight":"88rpx","fontSize":"28rpx","position":"fixed","height":"88rpx","zIndex":"9999"}' v-if="userid && isAuth('yonghu','新增')" class="add-btn" @click="onAddTap()">新增</button>
		<button :style='{"border":"2rpx solid #fff","boxShadow":"0 4rpx 8rpx rgba(0,0,0,.1)","color":"#333","bottom":"120rpx","right":"128rpx","outline":"none","borderRadius":"100%","background":"#f8deea","width":"88rpx","lineHeight":"88rpx","fontSize":"28rpx","position":"fixed","height":"88rpx","zIndex":"9999"}' v-if="!userid && isAuthFront('yonghu','新增')" class="add-btn" @click="onAddTap()">新增</button>
	</view>
</mescroll-uni>
</template>
